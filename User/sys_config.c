...
void GPIO_Configuration(void)
{
    ...
    /* Configure PA8 as normal gpio push-pull */
	...
	GPIO_InitStructure.GPIO_Pin = LED1_PINx;					//管脚选择，LED_PINx使用了宏定义
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;	    //管脚速率选择
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;		//管脚功能配置
    GPIO_Init(LED1_GPIOx, &GPIO_InitStructure);				//端口选择：如PA，PB口
    
    GPIO_ResetBits(LED1_GPIOx, LED1_PINx);                    //端口状态复位
