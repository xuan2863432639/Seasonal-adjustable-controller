...
#define RCC_LED_GPIOx   RCC_APB2Periph_GPIOB
#define LED1_PINx       GPIO_Pin_15
#define LED1_GPIOx      GPIOB
#define LED1_ON         GPIO_ResetBits(LED01_GPIOx, LED1_PINx)
#define LED1_OFF        GPIO_SetBits(LED1_GPIOx, LED1_PINx)
